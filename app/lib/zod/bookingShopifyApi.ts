 ...
 */
export const customerOrderGetByGroupParams = zod.object({
  customerId: zod.string(),
  orderId: zod.string(),
  groupId: zod.string(),
});

export const customerOrderGetByGroupResponse = zod.object({
  success: zod.boolean(),
  payload: zod
    .object({
      id: zod.number(),
 ...
 */
export const customerOrderRangeParams = zod.object({
  customerId: zod.string(),
});

export const customerOrderRangeQueryParams = zod.object({
  start: zod.string(),
  end: zod.string(),
});

export const customerOrderRangeResponse = zod.object({
  success: zod.boolean(),
  payload: zod.array(
    zod.object({
      id: zod.number(),
